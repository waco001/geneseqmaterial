...
var brainspan = new function() {
    ...
    var x_tick_values = [10, 100, 1000, 10000];
    ...
    var draw_svg = function(id, source, params) {
        ...
        $.post(source, {'gene_id': id}, function(data, status) {
            if (status == 'success' && data != null) {
                $('#three').addClass("mdl-cell--12-col");
                $('#three').append('<div class="brainspan-card mdl-card mdl-shadow--2dp"></div>');
                var brainspan_node = $('<div />', {
                    id: 'brainspan-chart',
                    class: 'chart'
                }).appendTo('div.brainspan-card');
